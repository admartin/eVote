            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form action ="voter-ballot.jsp" method="post" name = "ballot1" role="form">
                        ...
                        <form  action ="voter-ballot.jsp" role="form">
                            <div class="form-group">
			...
			if(b.getElectoralDistrict().getId()==(long)sess.getAttribute("district")) {
               ...
               Date close1 = ft.parse(b.getOpenDate());
    			...
    			//restore ballot items from ballot
    				System.out.println("BALNUM " +sess.getAttribute("balcount"));

    				sess.setAttribute("balid", b.getId());
    				sess.setAttribute("balx", b.getName());
					sess.setAttribute("main", b.getName());
    				%>
    				 
    		      	<script language="javascript">
    				var div2 = document.createElement('div');
    				div2.innerHTML = '<label > ${balx} </label> <br>'
    				+ '<button type="submit" name ="bal" value = ${balid} class="btn-default"> View </button>';
    				document.getElementById("ballot" + ${balcount} ).appendChild(div2);
