...
<script>
            ...
            <div class="container-fluid">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static">  <input type="text" value="${email}" readonly/> </p>
                        </div>
                      </div>
                     <div class="form-group">
                        <label class="col-sm-2 control-label">Username</label>
                        <div class="col-sm-10">
                            <p class="form-control-static"><input type="text" value="${username}" readonly/></p>
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="col-sm-2 control-label">Password</label>
                        <div class="col-sm-10">
                            <p class="form-control-static"><input type="password" value="${password}" readonly/></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <a href="eo-settings.jsp" class="btn btn-default" role="button">Edit</a>
                        </div>
                    </div>
                </form>
                </div>
	...
	<%
	    ...
	    try {
	    	...
	    	ElectionsOfficer eo1 = objectLayer.createElectionsOfficer(null, null, username, null, null, null);
            ...
            {
            	System.out.println(eolist.get(0).getUserName());
            }
	    }
