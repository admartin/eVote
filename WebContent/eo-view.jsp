            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-offset-1 col-sm-6">
                        <a href="eo-results.html">Spring 2016 Primaries</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-offset-1 col-sm-6">
                        <a href="eo-results.html">Summer 2016: New Park</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-offset-1 col-sm-6">
                        <a href="eo-results.html">Summer 2016: Rezoning</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-offset-1 col-sm-6">
                        <a href="eo-results.html">Fall 2016 Election</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-offset-1 col-sm-6">
