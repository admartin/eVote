...
<script language="javascript">
        function verify(){
        	if(confirm("Are you sure you wish to delete your account?")){
        		window.location.href = "delete-voter.jsp";
        	}
        	return false;
        }
</script>
            ...
            <div class="container-fluid">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static"><input id ="address" type="text" value="${address}" onfocus="this.value='';"/></p>
                        </div>
                    </div>
                    <div class="form-group">
	...
	<%
	    ...
	    try {
	    	...
	    	Voter vo1 = objectLayer.createVoter(null, null, null, username, password, email, address, age, null,-1);
