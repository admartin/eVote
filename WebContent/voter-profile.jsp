...
<script>
            ...
            <div class="container-fluid">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static"><input type="text" value="${address}" readonly/></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <a href="voter-settings.jsp" class="btn btn-default" role="button">Edit</a>
                        </div>
                    </div>
                </form>
                </div>
	...
	<%
	    ...
	    try {
            ...
            {
            	System.out.println(volist.get(0).getUserName());
            }
	    }
