...
public abstract class DbAccessConfig
{
    ...
    /** The database name
     */
    static final String DB_NAME        = "Project"; //change
     ...
     */
    static final String DB_CONNECTION_URL = "jdbc:mysql://localhost:3306/evote"; //change

    /** The database user name.
     */
    static  String DB_CONNECTION_USERNAME = "root"; //change
