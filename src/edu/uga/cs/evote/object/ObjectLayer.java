...
public interface ObjectLayer
{
    ...
    public Voter createVoter( String firstName, ElectoralDistrict dist, String lastName, String userName, String password, String emailAddress,
			String address, int age, List<VoteRecord> record, long district) throws EVException;
     ...
     */
    public PoliticalParty createPoliticalParty( long id, String name, List<Candidate> candidates) throws EVException;
     ...
     * @throws EVException in case name is null
     */
    public ElectoralDistrict createElectoralDistrict( int id, String Name, List<Ballot> ballotList, List<Voter> voterList ) throws EVException;
     ...
     */
    public Ballot createBallot( String name, String openDate, String closeDate, boolean approved, ElectoralDistrict electoralDistrict ) throws EVException;
     ...
     */
    public VoteRecord createVoteRecord(long id, Ballot ballot, Voter voter, Date date ) throws EVException;
    ...
    public BallotItem createBallotItem( Ballot ballot, int count, long electionId, long voterId ) throws EVException;
     ...
     * Return a List of ElectoralDistrict objects satisfying the search criteria given in the modelElectoralDistrict object.
     *
     * @param modelBallotItem
     * @return a List of the located ElectoralDistrict objects
     * @throws EVException in case there is a problem with the retrieval of the requested objects
     */
    public List<BallotItem> findBallotItem( BallotItem modelBallotItem ) throws EVException;
